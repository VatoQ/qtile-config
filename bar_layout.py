    ...
    return bar.Bar(
            [
                ...
                extrawidgets.AnalogueClock(
                    background=dim_color(BLUE, DARKER2),
                    face_shape="circle",
                    face_border_colour=dim_color(FOCUS_COLOR, NEUTRAL),
                    second_colour=dim_color(SECONDARY_COLOR, LIGHT),
                    hour_colour=dim_color(SECONDARY_COLOR, LIGHT),
                    minute_colour=dim_color(SECONDARY_COLOR, LIGHT),
                    face_background=dim_color(SECONDARY_COLOR, DARKER2),
                    face_border_width=2,
                    second_size=1,
                    second_length=0.7,
                    minute_length=0.7,
